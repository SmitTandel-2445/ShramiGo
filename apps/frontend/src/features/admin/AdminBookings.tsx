...
type BookingStatus = "Completed" | "In Progress" | "Pending" | "Cancelled";
      ...
      <main className="max-w-7xl mx-auto px-5 sm:px-8 py-7">
        {loadError && (
          <div className="mb-6 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
            Unable to load bookings: {loadError}
          </div>
        )}
        ...
        <div className="mb-7 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <SummaryCard
            ...
            title="Completed"
            value={String(
              bookingList.filter((booking) => booking.status === "Completed")
                .length,
            )}
          ...
          <SummaryCard
            ...
            title="In Progress"
            value={String(
              bookingList.filter((booking) => booking.status === "In Progress")
                .length,
            )}
        ...
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <CalendarDays size={20} className="text-[#087F7A]" />
          </div>
              ...
              <tbody>
                {filteredBookings.map((booking) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      <p className="text-sm font-medium">{booking.worker}</p>
                    </td>
              ...
              <div key={booking.id} className="p-5">
                ...
                <div className="grid grid-cols-2 gap-4 mt-5">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium mt-1">{booking.worker}</p>
                  </div>
          ...
          {filteredBookings.length === 0 && (
            <div className="py-14 text-center">
              ...
              <p className="font-medium mt-3">No bookings found</p>
            ...
            <div className="mt-6 p-4 rounded-2xl bg-[#087F7A]/5">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-xl bg-white flex items-center justify-center">
                  <ClipboardList size={21} className="text-[#087F7A]" />
                </div>

                <div>
                  <p className="text-xs text-gray-400">Service</p>

                  <p className="font-bold mt-1">{selectedBooking.service}</p>
                </div>
              </div>
            </div>
