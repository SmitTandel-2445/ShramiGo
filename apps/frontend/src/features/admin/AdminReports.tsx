        ...
        <div className="mb-6 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Values come from paid bookings in the database.
            </p>
          </div>
          <button
            type="button"
            ...
            disabled={loading}
            className="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-semibold disabled:opacity-50"
          >
        ...
        {error ? (
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {cards.map(([label, value]) => (
              ...
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#E8F6F5] text-[#087F7A]">
                  <IndianRupee size={19} />
                </div>
